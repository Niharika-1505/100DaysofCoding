...
def calculate_score(cards):
    ...
    if sum(cards) == 21 and len(cards) == 2:
        return 0
    # Ace can be 11 0r 1 so if the sum is > 21 we can just use ace as 1 instead of 11
...
def play_game():
    ...
    while not is_game_over:
        # Call calculate_score(). If the computer or the user has a blackjack (0) or if the user's score is
